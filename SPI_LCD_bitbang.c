...
uint16_t curr_display = 1; // number of current display, start at 1 so that first button interrupt correctly moves to next display
...
LCD_display(uint16_t display_number){
   ...
   case 2:
       ...
       break;
   case 3:
       LCD_data_array = LCD_data_array3;
       break;
   }
